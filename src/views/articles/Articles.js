  ...
  const articles = [
    {
      ...
      date: "June 28, 2026",
      summary: "The second half of the UX workflow is where AI output starts to look finished; polished microcopy, clickable prototypes, thorough spec documents; which is exactly when you need to be most critical. This article covers ideation, UX writing, prototyping, usability testing, and handoff documentation, with a practical framework for knowing when to evaluate with AI, when to generate with a tight brief, and when Figma is still the better tool. Five phases, five paste-ready prompts, and an honest take on where AI earns its place and where it doesn't.",
      id: 'a7ee2521-ce13-4628-804f-e3aa7c55d321'
    },
    {
      title: "AI for UX: AI Across the UX Workflow - Research and Discovery",
      link: "https://medium.com/@LadyCarni/ai-for-ux-ai-across-the-ux-workflow-research-and-discovery-499845f73a63",
      date: "May 20, 2026",
      summary: "The front end of the UX process is where AI has the highest potential leverage and the highest potential for false confidence. This article walks through four research phases; planning, interviewing, synthesis, and communicating insights; with worked examples that show the full arc from messy input to actionable output. The goal isn't to make AI do your research for you; it's to spend less time on the mechanical parts so you have more thinking left for the work that actually requires it.",
      id: 'ffbb2aa4-694a-4fc2-8f92-e88b1751f8db'
    },
    {
      title: "AI for UX: Prompts, Preferences, and Configuration",
      link: "https://medium.com/@LadyCarni/prompts-preferences-and-configuration-007cd743a89a",
      date: "May 13, 2026",
      summary: "Part 2 of the AI for UX series: system prompts, custom instructions, and the prompting patterns that make the difference between mediocre and useful.",
      id: '3fb39915-eec4-492b-9dae-075b367fbc82'
    },
    {
      title: "AI for UX: The Guide you wish someone had given you sooner",
      link: "https://medium.com/design-bootcamp/ai-for-ux-the-guide-you-wish-someone-had-given-you-sooner-d1401c9f2e0b",
      date: "April 30, 2026",
      summary: "The article I wish someone had handed me when AI started showing up everywhere in my UX workflow. Part 1 covers the foundations: how LLMs work, what separates a chat interface from a CLI tool, and why understanding the landscape is the first step to leading in it.",
      id: 'ed47cddf-8c70-4dee-bf81-43e77b054063'
    },
    {
      title: "Saying No with diplomacy",
      link: "https://medium.com/@LadyCarni/saying-no-with-diplomacy-d7f07e9ccd6d",
      date: "July 28, 2025",
      summary: "Saying no diplomatically can be challenging, but using a positive and constructive approach helps maintain good relationships and shows that we're still supportive, even if we can't fulfill the request as asked. Here are some conversational tips to help reframe or redirect requests.",
      id: '6551d965-8c02-48fe-9880-e6df60397b6f',
    },
    {
      title: "UX Resources",
      ...
      id: 'b1121a3c-5a90-4c65-87c4-647bfd8ab27d',
    },
    {
      ...
      id: 'c3f9e1d2-4b5a-4c6d-8f7e-9a2b3c4d5e6f',
    },
    {
      ...
      id: 'd4e5f6g7-8h9i-10j11-12k13-14l15m16n17o',
    },
    {
      ...
      id: 'e5f6g7h8-9i10-11j12-13k14-14l15m16n17o',
    },
    {
      ...
      id: 'f6g7h8i9-10j11-12k13-13l14-15m16n17o18p',
    },
    {
      ...
      id: 'g7h8i9j10-11k12-13l14-14m15n16o17p',
    },
    {
      ...
      id: 'h8i9j10k11-12l13-13m14-14n15o16p17q',
    },
    {
      ...
      id: 'i9j10k11-12l13-13m14-14n15o16p17q18r',
    },
    {
      ...
      id: 'j10k11-12l13-13m14-14n15o16p17q18r19s',
    },
    {
      ...
      id: 'k11l12-13m14-14n15o16p17q18r19s20t',
    },
    {
      ...
      id: 'l12m13-14n15o16p17q18r19s20t21u',
    },
    {
      ...
      id: 'm13n14-15o16p17q18r19s20t21u22v',
    },
    {
      ...
      id: 'n14o15-16p17q18r19s20t21u22v23w',
    },
    {
      ...
      id: 'o15p16-17q18r19s20t21u22v23w24x',
    },
  ];
