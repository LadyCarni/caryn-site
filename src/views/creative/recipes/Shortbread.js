...
const Ingredients = ({ media }) => {
  return (
    <div className={`${media} recipe-card`}>
      <h2>Ingredients</h2>
      <h3>Shortbread cookies ingredients</h3>
      <ul>
...
const Shortbread = () => {
  return (
    <div className="creative full-height">
      <Helmet>
        <title>Shortbread Cookies Recipe</title>
        <meta property="og:title" content="Shortbread Cookies Recipe" />
        <meta property="og:description" content="Shortbread cookies recipe." />
        <meta property="og:image" content={ShortbreadCookie} />
        <meta property="og:url" content="https://carynfarvour.design/creative/recipes/shortbread-cookies" />
